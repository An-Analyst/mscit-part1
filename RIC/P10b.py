...
titanic_train = pd.read_csv("C:/Users/Netra Karambelkar/Desktop/RIC Pracs/RICFiles/titanic_train.csv") # Read the data
...
metrics.confusion_matrix(y_true=titanic_train["Survived"],y_pred=preds) # Predicted labels
# View summary of common classification metrics
print(metrics.classification_report(y_true=titanic_train["Survived"],y_pred=preds) )
# Read and prepare test data
titanic_test = pd.read_csv("C:/Users/Netra Karambelkar/Desktop/RIC Pracs/RICFiles/titanic_test.csv") # Read the data
...
submission.to_csv("C:/Users/Netra Karambelkar/Desktop/RIC Pracs/RICFiles/tutorial_logreg_submission.csv",index=False) # Do not save index values
print(pd)
